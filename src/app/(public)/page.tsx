      ...
      <section className="my-12">
        <Container>
          <div className="flex flex-col items-center gap-4 md:flex-row">
            ...
            <div>
              <Heading className="mb-1 text-center md:text-left">Về bản thân</Heading>
          ...
          <div className="mt-6 text-justify text-lg leading-[1.5]">
            <p>
              ...
              sư phạm Toán. Mình tốt nghiệp đại học một chuyên ngành hoàn toàn khác nhưng mình đam
              mê việc dạy và học Toán. Vâng, các bạn nghe không nhầm đâu. Mình thích cả việc dạy và
              học Toán. Và mình đang và sẽ tiếp tục đi học Toán.
            </p>
            <p className="mt-3">
              Mình đang giảng dạy cho một số bạn học sinh cấp THCS và cấp THPT, không nhiều nhưng
              mong muốn của mình là giúp các bạn thích Toán học hơn. Không chỉ là giúp các bạn xây
              nền kiến thức, luyện tập tư duy Toán mà còn cả việc cải thiện điểm số trên trường lớp.
              Bạn có điểm số cao chưa chắc là bạn đã hiểu những gì bạn đã học, nhưng khi bạn hiểu
              chúng, bạn chắc chắn sẽ có điểm số cao. Việc của mình đang làm là hướng dẫn các bạn
              học Toán sao cho đúng, và tư duy bản chất nhiều nhất có thể.
            </p>
            <p className="mt-3">Rất hy vọng có thể gặp các bạn tại lớp học của mình!</p>
          </div>
        </Container>
      </section>
      <Separator />
      ...
      <section className="my-12">
        <Container>
          <div className="flex flex-col items-center gap-4 md:flex-row-reverse">
            <div className="border-border text-primary grid size-20 place-items-center rounded-md border-2">
              <PiIcon className="size-14" />
            </div>
            <div>
              <Heading className="mb-1 text-center md:text-right">Về Pixel Mathematics</Heading>
          ...
          <div className="mt-6 text-justify text-lg leading-[1.5]">
            <p className="mt-3">
              ...
              sinh đầu tiên. Mình chọn cái tên này vì mình có niềm yêu thích với Pixel Art. Mặc dù
              hiện tại mình không có nhiều thời gian dành cho việc vẽ chúng. Và có thể là vì nó nghe
              hay và không đụng hàng với hàng trăm khóa học online khác đang tồn tại ngoài kia.
            </p>
            <p className="mt-3">
              Mình thừa nhận mình không phải là một người quá cao siêu về Toán. Hiểu biết của mình
              có hạn và mình đang cố gắng trau dồi thêm kiến thức Toán học. Nhưng mình thích truyền
              đạt chúng cho các bạn. Các bạn có quyền lựa chọn bất kỳ khóa học và thầy cô nào khác.
              Có rất nhiều thầy cô giỏi hơn và nổi tiếng hơn mình. Còn nếu các bạn chọn mình, hy
              vọng chúng ta sẽ có khoảng thời gian tốt đẹp với nhau.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="mt-6 text-justify text-lg leading-[1.5]">
            <p>
              ...
              giống ai. Hy vọng lớp học của mình sẽ phù hợp với bạn.
            </p>
          </div>
